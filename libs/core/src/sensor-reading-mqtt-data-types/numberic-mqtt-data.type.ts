...
export class IlluminanceMqttData extends SensorReadingMqttData_base_class<'illuminance', number> {
  constructor(name: string, origin: string) {
    super('illuminance', name, origin, new SensorValueTypeSettings('illuminance', 'Lux', 0))
  }
}

export class TemperatureMqttData extends SensorReadingMqttData_base_class<'temperature', number> {
  constructor(name: string, origin: string) {
    super('temperature', name, origin, new SensorValueTypeSettings('temperature', '°C', 1))
  }
}

export class HumidityMqttData extends SensorReadingMqttData_base_class<'humidity', number> {
  constructor(name: string, origin: string) {
